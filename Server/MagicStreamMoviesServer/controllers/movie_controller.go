...
import (
	...
	"github.com/lva100/movie-streaming-service/Server/MagicStreamMoviesServer/models"
	"github.com/lva100/movie-streaming-service/Server/MagicStreamMoviesServer/utils"
...
func GetRecommendedMovies(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer func() {
			...
			if err != nil {
				log.Println("Don`t cursor close")
			}
		}()
